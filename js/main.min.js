...
$(function(){$(".footer__title").on("click",function(){$(this).toggleClass("footer__title--open-list"),$(this).next().slideToggle()}),$(".burger-btn").on("click",function(){$(this).toggleClass("burger-btn--cross"),$(".header__menu-list").toggleClass("header__menu-list--open")}),$(".widgets__slider-wrapper a, .header__logo-link, .footer__inter-logo, .footer__outer-logo").on("click",function(e){e.preventDefault();e=$(this).attr("href"),e=$(e).offset().top;$("body,html").animate({scrollTop:e},1500)}),$(document).on("scroll",function(){50<$(document).scrollTop()?$(".header__top").addClass("header__top--thin"):$(".header__top").removeClass("header__top--thin")}),$(".widgets__slider").slick({vertical:!0,arrows:!1,slidesToShow:4,initialSlide:3,speed:1500,waitForAnimate:!1}),$(".dot-0").on("click",function(e){e.preventDefault(),$(".widgets__slider").slick("goTo",3)}),$(".dot-1").on("click",function(e){e.preventDefault(),$(".widgets__slider").slick("goTo",2)}),$(".dot-2").on("click",function(e){e.preventDefault(),$(".widgets__slider").slick("goTo",1)}),$(".dot-3").on("click",function(e){e.preventDefault(),$(".widgets__slider").slick("goTo",0)})});